...
class Deposit extends AbstractEntity
{
    ...
    /**
     * The version of the application that made the deposit and created the export file.
     *
    ...
    /**
     * Deposit UUID, as generated by the PKP Preservation Network plugin.
     *
     * @Assert\Uuid
    ...
    public function __construct()
    {
        ...
        $this->version = self::DEFAULT_JOURNAL_VERSION;
    }
